...
CREATE TABLE HTL_FUNCIONARIO (
  FUNCIONARIO_ID   INTEGER GENERATED BY DEFAULT AS IDENTITY,
  ...
  CONSTRAINT UK_HTL_FUNCIONARIO_EMAIL UNIQUE (EMAIL)
);
...
CREATE TABLE HTL_FUNCAO (
  FUNCAO_ID INTEGER GENERATED BY DEFAULT AS IDENTITY,
  NAME      VARCHAR2(80)  NOT NULL,   -- UNIQUE
  CONSTRAINT PK_HTL_FUNCAO PRIMARY KEY (FUNCAO_ID),
  CONSTRAINT UK_HTL_FUNCAO_NAME UNIQUE (NAME)
);
...
CREATE TABLE HTL_HOSPEDE (
  HOSPEDE_ID     INTEGER GENERATED BY DEFAULT AS IDENTITY,
  CRIADO_POR     INTEGER        NOT NULL,
  NOME           VARCHAR2(150)  NOT NULL,
  CPF            VARCHAR2(14)   NOT NULL,    -- UNIQUE
  RG             VARCHAR2(20)   NULL,        -- UNIQUE
  ...
  CONSTRAINT UK_HTL_HOSPEDE_CPF UNIQUE (CPF),
  CONSTRAINT UK_HTL_HOSPEDE_RG UNIQUE (RG),
...
CREATE TABLE HTL_QUARTO (
  QUARTO_ID     INTEGER GENERATED BY DEFAULT AS IDENTITY,
  IDENTIFICADOR VARCHAR2(30)   NOT NULL,      --UNIQUE
  ...
  CONSTRAINT UK_HTL_QUARTO_IDENTIFICADOR UNIQUE (IDENTIFICADOR)
);
...
CREATE TABLE HTL_SERVICO (
  SERVICO_ID   INTEGER GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE HTL_RESERVA_STATUS (
  RESERVA_STATUS_ID INTEGER GENERATED BY DEFAULT AS IDENTITY,
  ...
  CONSTRAINT UK_HTL_RESERVA_STATUS_STATUS UNIQUE (STATUS)
);
...
CREATE TABLE HTL_RESERVA_STATUS_HIST (
  STATUS_HISTORICO_ID INTEGER GENERATED BY DEFAULT AS IDENTITY,
  RESERVA_STATUS_ID   INTEGER        NOT NULL,
...
-- CONSTRAINT UK_HTL_FUNCAO_NAME UNIQUE (NAME),
-- CONSTRAINT UK_HTL_HOSPEDE_CPF UNIQUE (CPF),
-- CONSTRAINT UK_HTL_HOSPEDE_RG UNIQUE (RG), -- RG, PODE CONTINUAR COMO NULL, PQ O ORACLE PERMITE UNIQUE VARIOS NULL
-- CONSTRAINT UK_HTL_QUARTO_IDENTIFICADOR UNIQUE (IDENTIFICADOR),
-- CONSTRAINT UK_HTL_RESERVA_STATUS_STATUS UNIQUE (STATUS)
-- ============================================================
