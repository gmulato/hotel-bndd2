DROP TABLE IF EXISTS `HTL_RESERVA_SERVICO`;
DROP TABLE IF EXISTS `HTL_RESERVA_STATUS_HIST`;
DROP TABLE IF EXISTS `HTL_RESERVA`;
DROP TABLE IF EXISTS `HTL_RESERVA_STATUS`;
DROP TABLE IF EXISTS `HTL_SERVICO`;
DROP TABLE IF EXISTS `HTL_QUARTO`;
DROP TABLE IF EXISTS `HTL_HOSPEDE`;
DROP TABLE IF EXISTS `HTL_FUNCIONARIO_FUNCAO`;
DROP TABLE IF EXISTS `HTL_FUNCAO`;
DROP TABLE IF EXISTS `HTL_FUNCIONARIO`;
