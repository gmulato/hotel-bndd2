DROP TABLE HTL_RESERVA_SERVICO CASCADE CONSTRAINT;
DROP TABLE HTL_RESERVA_STATUS_HIST CASCADE CONSTRAINT;
DROP TABLE HTL_RESERVA CASCADE CONSTRAINT;
DROP TABLE HTL_RESERVA_STATUS CASCADE CONSTRAINT;
DROP TABLE HTL_SERVICO CASCADE CONSTRAINT;
DROP TABLE HTL_QUARTO CASCADE CONSTRAINT;
DROP TABLE HTL_HOSPEDE CASCADE CONSTRAINT;
DROP TABLE HTL_FUNCIONARIO_FUNCAO CASCADE CONSTRAINT;
DROP TABLE HTL_FUNCAO CASCADE CONSTRAINT;
DROP TABLE HTL_FUNCIONARIO CASCADE CONSTRAINT;
